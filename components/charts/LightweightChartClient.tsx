...
interface LightweightChartClientProps {
...
export default function LightweightChartClient({
  chartType,
  data,
  showMA20,
  showMA200,
  ...
  return null; // This component just manages the chart in the container ref
}